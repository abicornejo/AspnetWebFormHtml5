<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/FIATube.Master" AutoEventWireup="true" CodeBehind="ReporteAsignacionNotas.aspx.cs" Inherits="FIATubeHtml5.Pages.Video.ReporteAsignacionNotas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" src="<%=ResolveUrl("~/Scripts/Modulos/Video/ReporteAsignacionNotas.js?Rand="+RandomCall) %>"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <div id="divFiltros" class="divButtonsBckgrndReportesAsigNotas">
        <label class="title">Local:</label>
        <select class="txtInputMaster varFloatLeft" id="cmbLocales"></select>
        <label class="title">Fecha Inicio:</label>
        <input class="txtFechas2" type="text" id="dtFechaIni" readonly="readonly" />
        <label class="title">Fecha Final:</label>
        <input class="txtFechas2" type="text" id="dtFechaFin" readonly="readonly" />

        <button type="button" id="btnBuscar" class="btnBuscarReporteAsigNotas" onclick="btnBuscar_click(); return false;"></button>
    </div>
    <br />
