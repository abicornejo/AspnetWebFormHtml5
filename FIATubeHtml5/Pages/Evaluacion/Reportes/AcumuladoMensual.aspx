<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/FIATube.Master" AutoEventWireup="true" CodeBehind="AcumuladoMensual.aspx.cs" Inherits="FIATubeHtml5.Pages.Evaluacion.Reportes.AcumuladoMensual" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
 <script type="text/javascript" src="<%=ResolveUrl("~/Scripts/Modulos/Evaluacion/Reportes/AcumuladoMensual.js?Rand="+RandomCall) %>"></script>    
    ...
    <script src="<%=ResolveUrl("~/Scripts/Datatable/ColVis.js?Rand="+RandomCall) %>" type="text/javascript"></script>
...
<div class="divAcumMensButtonsBckgrnd">
    <label for="cmbLocales">Local:</label>
    <select id="cmbLocales"></select>
    <label for="cmbSecciones">Secci&oacute;n:</label>
    <select id="cmbSecciones"></select>
    <label for="cmbPuesto">Puesto:</label>
    <select id="cmbPuesto"></select>
    <input type="checkbox" id="chkAnual" />
    <label for="chkAnual">Ver reporte anual</label>
   <%-- <button type="button" id="btnAutorizar" class="btnAutorizar"  title="Autorizar">Autorizar</button>
    <button type="button" id="btnEditMontos" class="btnEditMontos" title="Editar Montos">Editar Montos</button>
    <button type="button" id="btnSaveMontos" class="btnSaveMontos" title="Guardar Montos">Guardar</button>
    <button type="button" id="btnCancel" class="btnCancel" title="Cancelar">Cancelar</button>--%>

</div>
<br />

<div class="divPagAcumuladoMensual";>
    <input type="button" id="btnback" class="btnAtras" title="Anterior" style="cursor:pointer;" />
    <label id="lblWeekOfYear" class="lblWeekOfYear" ></label>
    <input type="button" id="btnforward" class="btnAdelante" title="Siguiente" style="cursor:pointer;" />   
</div>
<div id="ContAcumuladoMens" class="divContAcumuladoMens">
